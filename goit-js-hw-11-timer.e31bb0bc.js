  ...
  _createClass(CountdownTimer, [{
    ...
    value: function start() {
      ...
      setInterval(function () {
        ...
        var timeLeft = _this.getTimeComponents(time);

        _this.updateCountdownTimer(timeLeft);
      }, 1000);
    }
  }, {
    key: "updateCountdownTimer",
    value: function updateCountdownTimer(_ref2) {
      var days = _ref2.days,
          hours = _ref2.hours,
          mins = _ref2.mins,
          secs = _ref2.secs;
      var timerById = document.querySelector(this.selector);
      var daysTimer = timerById.querySelector('span[data-value="days"]');
      var hoursTimer = timerById.querySelector('span[data-value="hours"]');
      var minsTimer = timerById.querySelector('span[data-value="mins"]');
      var secsTimer = timerById.querySelector('span[data-value="secs"]');
      daysTimer.textContent = "".concat(days);
      hoursTimer.textContent = "".concat(hours);
      minsTimer.textContent = "".concat(mins);
      secsTimer.textContent = "".concat(secs);
    }
    /*
